...
int func1(int i, struct s1 *s1, struct s2 *s2)
{
10000508:	94 21 ff d0 	stwu    r1,-48(r1)
1000050c:	93 e1 00 2c 	stw     r31,44(r1)
10000510:	7c 3f 0b 78 	mr      r31,r1
10000514:	90 7f 00 18 	stw     r3,24(r31)
...
1000051c:	90 bf 00 20 	stw     r5,32(r31)
    ...
    int a = 1;
10000520:	39 20 00 01 	li      r9,1
10000524:	91 3f 00 08 	stw     r9,8(r31)

    s1->c = s2->b;
10000528:	81 3f 00 20 	lwz     r9,32(r31)
1000052c:	81 49 00 04 	lwz     r10,4(r9)
10000530:	81 3f 00 1c 	lwz     r9,28(r31)
10000534:	91 49 00 08 	stw     r10,8(r9)
    return static_var + static_var2 + a + i;
10000538:	3d 20 10 01 	lis     r9,4097
1000053c:	81 49 0b 90 	lwz     r10,2960(r9)
10000540:	3d 20 10 01 	lis     r9,4097
10000544:	81 29 0c 30 	lwz     r9,3120(r9)
10000548:	7d 4a 4a 14 	add     r10,r10,r9
1000054c:	81 3f 00 08 	lwz     r9,8(r31)
10000550:	7d 4a 4a 14 	add     r10,r10,r9
10000554:	81 3f 00 18 	lwz     r9,24(r31)
10000558:	7d 2a 4a 14 	add     r9,r10,r9
}
1000055c:	7d 23 4b 78 	mr      r3,r9
10000560:	39 7f 00 30 	addi    r11,r31,48
10000564:	83 eb ff fc 	lwz     r31,-4(r11)
10000568:	7d 61 5b 78 	mr      r1,r11
1000056c:	4e 80 00 20 	blr
...
int func2(int i)
{
10000570:	94 21 ff e0 	stwu    r1,-32(r1)
10000574:	7c 08 02 a6 	mflr    r0
...
10000584:	90 7f 00 08 	stw     r3,8(r31)
    if (i < 1) {
10000588:	81 3f 00 08 	lwz     r9,8(r31)
1000058c:	2f 89 00 00 	cmpwi   cr7,r9,0
10000590:	41 9d 00 0c 	bgt-    cr7,1000059c <func2+0x2c>
        return 3;
10000594:	39 20 00 03 	li      r9,3
10000598:	48 00 00 14 	b       100005ac <func2+0x3c>
    } else {
        printf("1 <= i\n");
...
100005ac:	7d 23 4b 78 	mr      r3,r9
100005b0:	39 7f 00 20 	addi    r11,r31,32
100005b4:	80 0b 00 04 	lwz     r0,4(r11)
100005b8:	7c 08 03 a6 	mtlr    r0
100005bc:	83 eb ff fc 	lwz     r31,-4(r11)
100005c0:	7d 61 5b 78 	mr      r1,r11
...
int func3(int i)
{
100005c8:	94 21 ff d0 	stwu    r1,-48(r1)
...
100005dc:	90 7f 00 18 	stw     r3,24(r31)
    int rc = -1;
100005e0:	39 20 ff ff 	li      r9,-1
100005e4:	91 3f 00 08 	stw     r9,8(r31)

    switch (i) {
100005e8:	81 3f 00 18 	lwz     r9,24(r31)
100005ec:	2f 89 00 02 	cmpwi   cr7,r9,2
100005f0:	41 9e 00 24 	beq-    cr7,10000614 <func3+0x4c>
100005f4:	2f 89 00 0f 	cmpwi   cr7,r9,15
100005f8:	41 9e 00 28 	beq-    cr7,10000620 <func3+0x58>
100005fc:	2f 89 00 01 	cmpwi   cr7,r9,1
10000600:	40 9e 00 34 	bne-    cr7,10000634 <func3+0x6c>
    case 1:
        rc = global_uninit_var;
...
10000618:	91 3f 00 08 	stw     r9,8(r31)
        break;
1000061c:	48 00 00 1c 	b       10000638 <func3+0x70>
    case 15:
        printf("i == 15");
10000620:	3d 20 10 00 	lis     r9,4096
...
10000634:	60 00 00 00 	nop
    ...
    return rc;
10000638:	81 3f 00 08 	lwz     r9,8(r31)
}
...
10000664:	90 7f 00 18 	stw     r3,24(r31)
    int i, sum = 0;
10000668:	39 20 00 00 	li      r9,0
1000066c:	91 3f 00 0c 	stw     r9,12(r31)

    for (i = 0; i < bound; ++i) {
10000670:	39 20 00 00 	li      r9,0
10000674:	91 3f 00 08 	stw     r9,8(r31)
10000678:	48 00 00 20 	b       10000698 <func4+0x40>
        sum += i;
1000067c:	81 5f 00 0c 	lwz     r10,12(r31)
10000680:	81 3f 00 08 	lwz     r9,8(r31)
10000684:	7d 2a 4a 14 	add     r9,r10,r9
10000688:	91 3f 00 0c 	stw     r9,12(r31)
//loop
int func4(int bound)
{
    int i, sum = 0;
    ...
    for (i = 0; i < bound; ++i) {
1000068c:	81 3f 00 08 	lwz     r9,8(r31)
10000690:	39 29 00 01 	addi    r9,r9,1
10000694:	91 3f 00 08 	stw     r9,8(r31)
10000698:	81 5f 00 08 	lwz     r10,8(r31)
1000069c:	81 3f 00 18 	lwz     r9,24(r31)
100006a0:	7f 8a 48 00 	cmpw    cr7,r10,r9
...
100006e4:	91 5f 00 44 	stw     r10,68(r31)
100006e8:	90 7f 00 48 	stw     r3,72(r31)
    va_list argp;
    int i, sum = 0;
100006ec:	39 20 00 00 	li      r9,0
100006f0:	91 3f 00 0c 	stw     r9,12(r31)
...
10000718:	91 3f 00 08 	stw     r9,8(r31)
...
10000784:	81 5f 00 08 	lwz     r10,8(r31)
10000788:	81 3f 00 48 	lwz     r9,72(r31)
1000078c:	7f 8a 48 00 	cmpw    cr7,r10,r9
10000790:	41 9c ff 90 	blt+    cr7,10000720 <func5+0x60>
        sum += va_arg(argp, int);
    }
    va_end(argp);
    return sum;
...
1000082c:	91 1f 00 08 	stw     r8,8(r31)
10000830:	91 5f 00 0c 	stw     r10,12(r31)
10000834:	91 3f 00 10 	stw     r9,16(r31)
        .a = 1,
        .b = 2,
        .c = 3,
    };
